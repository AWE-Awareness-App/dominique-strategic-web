...
const translations = {
  en: {
    ...
    'services.couples.description': 'Bring, joy, play, communication and less conflict in your family of whatever size and makeup. Let\'s make it matter together.',
  ...
  fr: {
    ...
    'services.couples.description': 'Apportez de la joie, du jeu, de la communication et moins de conflits dans votre famille, quelle que soit sa taille ou sa composition. Faisons-en quelque chose qui compte, ensemble.',
  ...
  es: {
    ...
    'services.couples.description': 'Aporta alegría, juego, comunicación y menos conflictos a tu familia, sin importar su tamaño o composición. Hagamos que importe, juntos.',
