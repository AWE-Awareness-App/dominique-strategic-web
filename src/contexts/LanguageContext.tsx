...
const translations = {
  en: {
    ...
    'services.couples.cta': 'Book a Session for couples (1:2)',
    'services.family.title': 'Family Reconnection',
    'services.family.description': 'Bring, joy, play, communication and less conflict in your family of whatever size and makeup. Let\'s make it matter together.',
    'services.family.cta': 'Book a Session for family',
  ...
  fr: {
    ...
    'services.couples.cta': 'Réserver une Séance pour les couples (1:2)',
    'services.family.title': 'Famille Reconnection',
    'services.family.description': 'Apportez de la joie, du jeu, de la communication et moins de conflits dans votre famille, quelle que soit sa taille ou sa composition. Faisons-en quelque chose qui compte, ensemble.',
    'services.family.cta': 'Réserver une Séance pour la famille',
  ...
  es: {
    ...
    'services.couples.cta': 'Reservar una Sesión para las parejas (1:2)',
    'services.family.title': 'Familia Reconnection',
    'services.family.description': 'Aporta alegría, juego, comunicación y menos conflictos a tu familia, sin importar su tamaño o composición. Hagamos que importe, juntos.',
    'services.family.cta': 'Reservar una Sesión para la familia',
